...
//				trap_Cmd_ExecuteText( EXEC_APPEND, va("addbot %s %i %s\n", UI_GetBotNameByNumber(uiInfo.botIndex), uiInfo.skillIndex+1, (uiInfo.redBlue == 0) ? "Red" : "Blue") );
			...
			Menu_ShowItemByName( menu, "misc_resetmatch", (qboolean)(flags & VOTEFLAGS_RESETMATCH) );
			Menu_ShowItemByName( menu, "misc_startmatch", (qboolean)(flags & VOTEFLAGS_STARTMATCH ));
			Menu_ShowItemByName( menu, "misc_nextmap", (qboolean)(flags & VOTEFLAGS_NEXTMAP ));
			Menu_ShowItemByName( menu, "misc_swap", (qboolean)(flags & VOTEFLAGS_SWAP ));
			Menu_ShowItemByName( menu, "ctr_gametype", (qboolean)(flags & VOTEFLAGS_TYPE ));
			Menu_ShowItemByName( menu, "ctr_kickplayer", (qboolean)(flags & VOTEFLAGS_KICK ));
			Menu_ShowItemByName( menu, "ctr_changemap", (qboolean)(flags & VOTEFLAGS_MAP ));
...
void _UI_Init( qboolean inGameLoad ) {
	...
	UI_LoadMenus( "ui_mp/menus.txt", qfalse );
