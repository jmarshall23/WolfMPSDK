...
//	vec3_t			mins, maxs; // TTimo: unused
	...
	spectator = (qboolean)(( ( cg.predictedPlayerState.pm_type == PM_SPECTATOR ) || ( cg.predictedPlayerState.pm_flags & PMF_LIMBO ) )); // JPW NERVE
...
void CG_PredictPlayerState( void ) {
	...
	//----(SA)	added
	cg_pmove.noWeapClips = (qboolean)(( cgs.dmflags & DF_NO_WEAPRELOAD ) > 0);
