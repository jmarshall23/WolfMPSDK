...
BOOL CreateEntityWindow(HINSTANCE hInstance)
{
	...
	OldFieldWindowProc = (WNDPROC)GetWindowLongPtr (hwndEnt[EntKeyField], GWLP_WNDPROC);
	SetWindowLong (hwndEnt[EntKeyField], GWLP_WNDPROC, (long)FieldWndProc);
	SetWindowLong (hwndEnt[EntValueField], GWLP_WNDPROC, (long)FieldWndProc);

	OldEntityListWindowProc = (WNDPROC)GetWindowLongPtr(hwndEnt[EntList], GWLP_WNDPROC);
	SetWindowLong (hwndEnt[EntList], GWLP_WNDPROC, (long)EntityListWndProc);
